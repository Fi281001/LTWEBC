    ...
    public class SupplierDAL : _BaseDAL, ICommonDAL<Supplier>
    {
        ...
        public int Add(Supplier data)
        {
            ...
            using (SqlConnection cn = OpenConnection())
            {
                ...
                cmd.Parameters.AddWithValue("@ContactName", data.ContacName);
            ...
            using (SqlConnection cn = OpenConnection())
            {
                ...
                if (dbReader.Read())
                {
                    data = new Supplier()
                    {
                        ...
                        ContacName = Convert.ToString(dbReader["ContactName"]),
        ...
        /// <param name="searchValue"></param>
        /// <returns></returns>
        public IList<Supplier> List(int page, int pageSize, string searchValue, int rowCount)
        {
